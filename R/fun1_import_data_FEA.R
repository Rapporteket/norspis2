#import data (and convert it to a tibble for convinience, e.g. easier to work with in the console than a data.frame)

#(function name when writing aarsrapport 2019 (in 2020): import11_data)
