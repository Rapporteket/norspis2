...
#
# density(x=as.numeric(as.Date(DL$RegDataStartEndNatVal22$HovedDato.y)-as.Date(DL$RegDataStartEndNatVal22$HovedDato.x)), na.rm = T)
#
# plot(density(x=as.numeric(as.Date(DL$RegDataStartEndNatVal22$HovedDato.y)-as.Date(DL$RegDataStartEndNatVal22$HovedDato.x)), na.rm = T))
#
# hist(x=as.numeric(as.Date(DL$RegDataStartEndNatVal22$HovedDato.y)-as.Date(DL$RegDataStartEndNatVal22$HovedDato.x)),
#      na.rm = T,
#      breaks = max(as.numeric(as.Date(DL$RegDataStartEndNatVal22$HovedDato.y)-as.Date(DL$RegDataStartEndNatVal22$HovedDato.x)), na.rm = T))
#
# hist(x=as.numeric(as.Date(DL$RegDataStartEndNatVal22$HovedDato.y)-as.Date(DL$RegDataStartEndNatVal22$HovedDato.x)),
#      na.rm = T)
#
