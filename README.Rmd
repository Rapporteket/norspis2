...
Still, in the future, when the situation allows we will aim to make functions that can have utilty for others, 
in particular other medical quality regitries.  
