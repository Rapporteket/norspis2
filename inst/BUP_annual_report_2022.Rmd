...
if (!dir.exists("~/.ssh/2022norspisdata_BUP/")) {
  dir.create("~/.ssh/2022norspisdata_BUP/")
}
...
### Startregistreringer
  ...
  start <- norspis2::make_table_DQ_regCountYearly(RegDataNatValFiltered = RegDataNatValFiltered,
                                         saveAsImage = T,
                                         saveAsDoc = T,
                                         pathToSaveTableFile = "~/.ssh/2022norspisdata_BUP/",
...
flextable::save_as_docx("nRegAllYears" = ft, path = paste0("~/.ssh/2022norspisdata_BUP/", "nRegAllYears.docx"))
...
ft <- flextable::flextable(merged)
flextable::save_as_docx("nRegAllYearsEnd" = ft, path = paste0("~/.ssh/2022norspisdata_BUP/", "nRegAllYearsEnd.docx"))
...
flextable::save_as_docx("nUniqiePatients" = ft, path = paste0("~/.ssh/2022norspisdata_BUP/", "nUniquePatients.docx"))
...
data_start_end_tom2021_onlyEndIkkeAvbrudd_BUP <- 
...
#filter data for comparison point
data_start_end_2022_onlyEndIkkeAvbrudd_BUP <- 
  norspis2::fun3_2_filter_RegDataStartEnd(RegData = data_start_end_BUP,
                                          dateFrom.y  =
                                            "2022-01-01",
                                          dateTo.y =
...
data_ordinary_tom2022_BUP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_BUP,
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
                                          "2022-12-31",
...
data_ordinary_tom2022_only_start_BUP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_BUP,
                                        regType = c(1,2,3,4), #<-                           
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
...
data_ordinary_tom2022_only_end_BUP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_BUP,
                                        regType = c(5,6,98,99), #<-                           
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
...
data_ordinary_tom2022_only_end_ikkeavbrudd_BUP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_BUP,
                                        regType = c(5,6), #<-                           
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
...
data_ordinary_tom2022_only_end_avbrudd_utred_BUP <- 
...
data_ordinary_only2022_only_end.slutt_and_start.utred_BUP <- 
  norspis2::fun3_1_filter_RegData(RegData = data_ordinary_BUP,
                                        regType = c(1,2,5,6), #<-
                                        dateFrom =
                                          "2022-01-01",
...
data_ordinary_only2022_BUP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_BUP,
                                        dateFrom =
                                          "2022-01-01",
                                        dateTo =
                                          "2022-12-31",
...
data_ordinary_only2022_only_start_BUP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_BUP,
                                        regType = c(1,2,3,4), #<-
                                        dateFrom =
                                          "2022-01-01",
                                        dateTo =
...
data_ordinary_only2022_only_end_ikkeavbrudd_BUP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_BUP,
                                        regType = c(5,6), #<-
                                        dateFrom =
                                          "2022-01-01",
                                        dateTo =
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI1_time[[3]], 
                          path = paste0("~/.ssh/2022norspisdata_BUP/", "KI_EDEQ_endring_time.docx"))
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI2_time[[3]], 
                          path = paste0("~/.ssh/2022norspisdata_BUP/", "KI_CIA_endring_time.docx"))
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI3_time[[3]], 
                          path = paste0("~/.ssh/2022norspisdata_BUP/", "KI_undervektsendring_time.docx"))
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI5_time[[3]], 
                          path = paste0("~/.ssh/2022norspisdata_BUP/", "KI5_PROP_PT03Utfallsvurd_time.docx"))
