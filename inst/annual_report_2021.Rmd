...
# library(dplyr)
<<<<<<< HEAD
if (!dir.exists("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/")) {
  dir.create("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/")
=======
figfolder <- "~/.ssh/norspis/norspisdata_aarsrapp2021/"
if (!dir.exists(figfolder)) {
  dir.create(figfolder)
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
}
#------DATA norspis2
...
```{r}
## Totaloversikt (skal nok ikke bruke denne tabellen, men for å triangulere)
...
### Startregistreringer
  ...
  start <- norspis2::make_table_DQ_regCountYearly(RegDataNatValFiltered = RegDataNatValFiltered,
                                         ...
                                         saveAsDoc = T,
<<<<<<< HEAD
                                         pathToSaveTableFile = "~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/",
=======
                                         pathToSaveTableFile = figfolder,
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
flextable::save_as_docx("nRegAllYears" = ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "nRegAllYears.docx"))
=======
flextable::save_as_docx("nRegAllYears" = ft, path = paste0(figfolder, "nRegAllYears.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792


```

## Samme som over men for sluttdata
```{r}
#merge the two diffferent start data from above (start data for "kun utredning" and all start data)
#https://stackoverflow.com/questions/27167151/merge-combine-columns-with-same-name-but-incomplete-data
...
ft <- flextable::flextable(merged)
<<<<<<< HEAD
flextable::save_as_docx("nRegAllYearsEnd" = ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "nRegAllYearsEnd.docx"))
=======
flextable::save_as_docx("nRegAllYearsEnd" = ft, path = paste0(figfolder, "nRegAllYearsEnd.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
Antall unike pasienter per aar
```{r}
...
<<<<<<< HEAD
flextable::save_as_docx("nUniqiePatients" = ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "nUniquePatients.docx"))
=======
flextable::save_as_docx("nUniqiePatients" = ft, path = paste0(figfolder, "nUniquePatients.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
#data
data <- DL$RegDataStartEndNatVal2

dat1 <- norspis2::fun3_2_filter_RegDataStartEnd(RegData = data,
                                        dateFrom.y =
                                          "2012-01-01",
                                        dateTo.y =
                                          "2020-12-31",
...
dat2 <- norspis2::fun3_2_filter_RegDataStartEnd(RegData = data,
                                                dateFrom.y  =
                                                  "2021-01-01",
                                                dateTo.y =
                                                  "2021-12-31",
...
data_start_end <- DL$RegDataStartEnd2

data_start_end_tom2020_onlyEndIkkeAvbrudd <- 
  norspis2::fun3_2_filter_RegDataStartEnd(RegData = data_start_end,
                                          dateFrom.y =
                                            "2012-01-01",
                                          dateTo.y =
                                            "2020-12-31",
...
#filter data for comparison point
data_start_end_2021_onlyEndIkkeAvbrudd <- 
  norspis2::fun3_2_filter_RegDataStartEnd(RegData = data_start_end,
                                          dateFrom.y  =
                                            "2021-01-01",
                                          dateTo.y =
...
data_ordinary_tom2020 <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
                                          "2020-12-31",
...
data_ordinary_tom2021 <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        ...
                                        dateTo =
                                          "2021-12-31",
                                        regStatus = 1) #only complete reg
data_ordinary_tom2021_only_start <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        regType = c(1,2,3,4), #<-                           
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
...
data_ordinary_tom2021_only_end <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        regType = c(5,6,98,99), #<-                           
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
...
data_ordinary_tom2021_only_end_ikkeavbrudd <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        regType = c(5,6), #<-                           
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
...
data_ordinary_tom2021_only_end_avbrudd_utred <- 
  norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
...
data_ordinary_only2021_only_end.slutt_and_start.utred <- 
  norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        regType = c(1,2,5,6), #<-
                                        dateFrom =
                                          "2021-01-01",
...
data_ordinary_only2021 <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        dateFrom =
                                          "2021-01-01",
                                        dateTo =
                                          "2021-12-31",
...
data_ordinary_only2021_only_start <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        regType = c(1,2,3,4), #<-
                                        dateFrom =
                                          "2021-01-01",
                                        dateTo =
...
data_ordinary_only2021_only_end_ikkeavbrudd <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        regType = c(5,6), #<-
                                        dateFrom =
                                          "2021-01-01",
                                        dateTo =
...
data_ordinary1 <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
                                          "2020-12-31",
...
data_ordinary2 <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary,
                                                dateFrom  =
                                                  "2021-01-01",
                                                dateTo =
                                                  "2021-12-31",
...
#data
data <- DL$RegDataNatVal2

dat1_end <- norspis2::fun3_1_filter_RegData(RegData = DL$RegDataNatVal2,
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
                                          "2020-12-31",
                                        regStatus = 1)#only complete reg
#filter data for comparison point
dat2_end <- norspis2::fun3_1_filter_RegData(RegData = DL$RegDataNatVal2,
                                        dateFrom  =
                                          "2021-01-01",
                                        dateTo =
                                          "2021-12-31",
...
#fig
fig <- norspis2::make_figFig_unitCompar(my_proptable_hospitals=tab3, 
                                        showErrorBar = F,
...
ggsave(filename = "KI_EDEQ_endring.png", 
       height = 6,
       width = 6,
       plot= last_plot(), 
...
<<<<<<< HEAD
                          path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "KI_EDEQ_endring_time.docx"))
=======
                          path = paste0(figfolder, "KI_EDEQ_endring_time.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
#prop.test som gir x2-statistics, men skal vÃ¦re lik som en z-test
prop.test(x=c(tabNasjonal$n*(tabNasjonal$perc/100),
              tabNasjonal$n.compare*(tabNasjonal$perc.compare/100)),
          n = c(tabNasjonal$n, 
                tabNasjonal$n.compare))
...
z.prop(tabNasjonal$n*(tabNasjonal$perc/100), 
       tabNasjonal$n.compare*(tabNasjonal$perc.compare/100),
       tabNasjonal$n,
       tabNasjonal$n.compare)
...
<<<<<<< HEAD
                          path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "KI_CIA_endring_time.docx"))
=======
                          path = paste0(figfolder, "KI_CIA_endring_time.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792

```

### KI3: Bortfall av undervekt
```{r KI3}
#tables to plot
tab1 <- norspis2::make_figTable_unitCompar(
  myIndata_NatVal =  dat1,
...
<<<<<<< HEAD
                          path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "KI_undervektsendring_time.docx"))
=======
                          path = paste0(figfolder, "KI_undervektsendring_time.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
#                           path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "KI4_PROP_PO09Utbytte_time.docx"))
=======
#                           path = paste0(figfolder, "KI4_PROP_PO09Utbytte_time.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
                          path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "KI5_PROP_PT03Utfallsvurd_time.docx"))
=======
                          path = paste0(figfolder, "KI5_PROP_PT03Utfallsvurd_time.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
mytitle <- '"Mener du at du på noen måte ble feilbehandlet \n (etter det du selv kan bedÃ¦mme)?"' 
...
ggplot(data, aes(x= PT,y=gj_sn*100, fill=as.factor(Year_custom)))+
...
#Choose variables to present in table
  ...
  myvarNames <- c("PasientKjonn" = "Kjønn",
...
# # #To print:
<<<<<<< HEAD
  flextable::save_as_image(popCharTab_ft, path=paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "sosiodemCharAlleAar2.png"))
=======
  flextable::save_as_image(popCharTab_ft, path=paste0(figfolder, "sosiodemCharAlleAar2.png"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
  flextable::save_as_docx(
    "Tabell 3.1: Sosiodemografiske karakteristika ved de registrerte pasientene,
under oppstart i behandling, for alle år siden registerets oppstart frem til 
og med 2020. N angir antall gyldige observasjoner"= popCharTab_ft, 
<<<<<<< HEAD
                          path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "sosiodemCharAlleAar2.docx"))
=======
                          path = paste0(figfolder, "sosiodemCharAlleAar2.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
  flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "negativeEvents.docx"))
=======
  flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0(figfolder, "negativeEvents.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
flextable::save_as_docx("diagnoser" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "diagnoses.docx"))
=======
flextable::save_as_image(popCharTab_ft, path=paste0(figfolder, "sosiodemCharAlleAar.png"))
flextable::save_as_docx("diagnoser" = popCharTab_ft, path = paste0(figfolder, "diagnoses.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
  flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "bmiStart.docx"))
=======
  flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0(figfolder, "bmiStart.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "bmiEnd.docx"))
=======
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0(figfolder, "bmiEnd.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "psychofarmacaStart.docx"))
=======
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0(figfolder, "psychofarmacaStart.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "psychofarmacaEnd.docx"))
=======
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0(figfolder, "psychofarmacaEnd.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
 flextable::save_as_docx("variabelkompletthet2021" = ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "variabelkompletthet2021.docx"))
=======
 flextable::save_as_docx("variabelkompletthet2021" = ft, path = paste0(figfolder, "variabelkompletthet2021.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
 flextable::save_as_docx("variabelkompletthet_KI_2021" = ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "variabelkompletthet_KI_2021.docx"))
=======
 flextable::save_as_docx("variabelkompletthet_KI_2021" = ft, path = paste0(figfolder, "variabelkompletthet_KI_2021.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
 flextable::save_as_docx("variabelkompletthet_PasErf_og_PT_2021" = ft, path = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "variabelkompletthet_PasErf_og_PT_2021.docx"))
=======
 flextable::save_as_docx("variabelkompletthet_PasErf_og_PT_2021" = ft, path = paste0(figfolder, "variabelkompletthet_PasErf_og_PT_2021.docx"))
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<<<<<<< HEAD
<!-- kableExtra::save_kable(x = table_BU_spec_kable_html, file = paste0("~/.ssh/norspisdata_nydata_ingen_skille_aarsrapport2021/", "table_BU_spec.jpeg")) -->
=======
<!-- kableExtra::save_kable(x = table_BU_spec_kable_html, file = paste0(figfolder, "table_BU_spec.jpeg")) -->
>>>>>>> 36840f851fa863f621e483592dfbe7dce73db792
...
<!--                         path = paste0(figfolder, "table_BU_spec.docx") -->
<!--                         ) -->
