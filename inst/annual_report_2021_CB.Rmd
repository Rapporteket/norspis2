...
"~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/" <- "~/.ssh/norspisdata_aarsrapp2021/"
if (!dir.exists("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/")) {
  dir.create("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/")
}
...
flextable::save_as_docx("nRegAllYears" = ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "nRegAllYears.docx"))
...
ft <- flextable::flextable(merged)
flextable::save_as_docx("nRegAllYearsEnd" = ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "nRegAllYearsEnd.docx"))
...
flextable::save_as_docx("nUniqiePatients" = ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "nUniquePatients.docx"))
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI1_time[[3]], 
                          path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "KI_EDEQ_endring_time.docx"))
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI2_time[[3]], 
                          path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "KI_CIA_endring_time.docx"))
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI3_time[[3]], 
                          path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "KI_undervektsendring_time.docx"))
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI5_time[[3]], 
                          path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "KI5_PROP_PT03Utfallsvurd_time.docx"))
...
#Choose variables to present in table
  ...
  myvarNames <- c("PasientKjonn" = "Kjønn",
                  ...
                  "B05FullfortUtd_MISSING_NAMES" = "Fullført utdanning",
...
#changing the names to appear in table:
  ...
  popCharTab_ft <- norspis2::make_table_popchar(
                              RegData = data_ordinary_tom2021_only_start_BUP, 
...
# # #To print:
  flextable::save_as_image(popCharTab_ft, path=paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "sosiodemCharAlleAar2.png"))
  flextable::save_as_docx(
...
og med 2020. N angir antall gyldige observasjoner"= popCharTab_ft, 
                          path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "sosiodemCharAlleAar2.docx"))
...
# # #To print:
  ...
  flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "negativeEvents.docx"))
...
myvarNames <- c("DiagSF_V_BU_MISSING_NAMES" = "Diagnoser (ICD-10)"
                ...
                # "MedBlodprove_CAT_MISSING" = "Blodprøve siste måned",
                # "MedBeintetthMaling_CAT_MISSING" = "Beintetthetsmåling siste år" 
                )

popCharTab_ft <- 
  norspis2::make_table_popchar(
    RegData = data_ordinary_tom2021_only_end_avbrudd_utred_BUP, 
    varsInTab = myvarString,
    varsNames = myvarNames,
...
flextable::save_as_docx("diagnoser" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "diagnoses.docx"))
...
# # #To print:
  ...
  flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "bmiStart.docx"))
...
popCharTab_ft <- 
  norspis2::make_table_popchar(
    RegData = data_ordinary_tom2021_only_end_ikkeavbrudd_BUP, 
    varsInTab = myvarString,
    varsNames = myvarNames,
    font_size_ft = 8,
    row_height_ft = 0.2,
...
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "bmiEnd.docx"))
...
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "psychofarmacaStart.docx"))
...
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "psychofarmacaEnd.docx"))
...
tab <- 
  norspis2::make_table_DQ_missing(RegData = data_ordinary_tom2020_BUP, 
                                  varsInMissTab = myvarStringMiss,
                                  #comparison
                                  comparison = TRUE,
                                  RegDataComparison = data_ordinary_only2021_BUP) 
...
tab2 <- 
  norspis2::make_table_DQ_missing(RegData = data_start_end_tom2020_onlyEndIkkeAvbrudd_BUP,  
                       varsInMissTab = myvarStringMissStartEnd,
                       #comparison
                       comparison = TRUE,
                       RegDataComparison = data_start_end_2021_onlyEndIkkeAvbrudd_BUP) 
...
ft
 ...
 flextable::save_as_docx("variabelkompletthet2021" = ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "variabelkompletthet2021.docx"))
...
ft
 ...
 flextable::save_as_docx("variabelkompletthet_KI_2021" = ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "variabelkompletthet_KI_2021.docx"))
...
ft
 ...
 flextable::save_as_docx("variabelkompletthet_PasErf_og_PT_2021" = ft, path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "variabelkompletthet_PasErf_og_PT_2021.docx"))
...
<!-- kableExtra::save_kable(x = table_BU_spec_kable_html, file = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "table_BU_spec.jpeg")) -->
...
<!-- #                           path = paste0("~/.ssh/norspisdata_nydata_BUP_aarsrapport2021/", "KI4_PROP_PO09Utbytte_time.docx")) -->
