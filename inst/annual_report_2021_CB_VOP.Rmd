...
if (!dir.exists("~/.ssh/norspisdata_aarsrapp2021_VOP/")) {
  dir.create("~/.ssh/norspisdata_aarsrapp2021_VOP/")
}
...
### Startregistreringer
  ...
  start <- norspis2::make_table_DQ_regCountYearly(RegDataNatValFiltered = RegDataNatValFiltered,
                                         saveAsImage = T,
                                         saveAsDoc = T,
                                         pathToSaveTableFile = "~/.ssh/norspisdata_aarsrapp2021_VOP/",
...
flextable::save_as_docx("nRegAllYears" = ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "nRegAllYears.docx"))
...
ft <- flextable::flextable(merged)
flextable::save_as_docx("nRegAllYearsEnd" = ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "nRegAllYearsEnd.docx"))
...
flextable::save_as_docx("nUniqiePatients" = ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "nUniquePatients.docx"))
...
data_start_end_tom2020_onlyEndIkkeAvbrudd_VOP <- 
...
#filter data for comparison point
data_start_end_2021_onlyEndIkkeAvbrudd_VOP <- 
  norspis2::fun3_2_filter_RegDataStartEnd(RegData = data_start_end_VOP,
                                          dateFrom.y  =
                                            "2021-01-01",
                                          dateTo.y =
...
data_ordinary_tom2020_VOP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_VOP,
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
                                          "2020-12-31",
...
data_ordinary_tom2021_only_start_VOP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_VOP,
                                        regType = c(1,2,3,4), #<-                           
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
...
data_ordinary_tom2021_only_end_VOP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_VOP,
                                        regType = c(5,6,98,99), #<-                           
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
...
data_ordinary_tom2021_only_end_ikkeavbrudd_VOP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_VOP,
                                        regType = c(5,6), #<-                           
                                        dateFrom =
                                          "2012-01-01",
                                        dateTo =
...
data_ordinary_only2021_only_end.slutt_and_start.utred_VOP <- 
  norspis2::fun3_1_filter_RegData(RegData = data_ordinary_VOP,
                                        regType = c(1,2,5,6), #<-
                                        dateFrom =
                                          "2021-01-01",
...
data_ordinary_only2021_VOP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_VOP,
                                        dateFrom =
                                          "2021-01-01",
                                        dateTo =
                                          "2021-12-31",
...
data_ordinary_only2021_only_start_VOP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_VOP,
                                        regType = c(1,2,3,4), #<-
                                        dateFrom =
                                          "2021-01-01",
                                        dateTo =
...
data_ordinary_only2021_only_end_ikkeavbrudd_VOP <- norspis2::fun3_1_filter_RegData(RegData = data_ordinary_VOP,
                                        regType = c(5,6), #<-
                                        dateFrom =
                                          "2021-01-01",
                                        dateTo =
...
ggsave(filename = "KI_EDEQ_endring_VOP.png", 
       ...
       width = 6,
       plot= last_plot(), 
       path = "~/.ssh/norspisdata_aarsrapp2021_VOP")
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI1_time[[3]], 
                          path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "KI_EDEQ_endring_time.docx"))
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI2_time[[3]], 
                          path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "KI_CIA_endring_time.docx"))
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI3_time[[3]], 
                          path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "KI_undervektsendring_time.docx"))
...
#merge columns for perc into tab1
#(only keeping rows from 1 by left_join):
tab3_VOP <- left_join(tab1_VOP,tab2_VOP, by="AvdNavnNavn",
                  #add sufix only to merged data
                  suffix = c("",".compare"))
...
myvarZ <- expr(PT03Utfallsvurd) #quo(PO10Pasientsikkerhet.x)
mycatZ <- expr(c(0,1,2,3,4,5)) #the categories of the variables you want to bring into proportions calculations
mylabZ <- vars("0"="Ikke i det hele tatt", #alternatively to vars, use "exprs(" from biobase??
              "1"="Ikke noe problem\n lenger",
              "2"="Klar bedring",
              "3"="Noe bedring",
              "4"= "Uendret",
...
mytitle <- '"pasientvurdert bedring"' 
...
ggsave(filename = "PT03Utfallsvurd_fordelt.png", 
       height = 5,
       width = 8,
       plot= last_plot(), 
       path = "~/.ssh/norspisdata_aarsrapp2021_VOP") 
...
flextable::save_as_docx(
    "Tabell 3.1: Text"= KI5_time[[3]], 
                          path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "KI5_PROP_PT03Utfallsvurd_time.docx"))
...
data_gjsn_VOP <- data_ordinary_tom2021_VOP %>% 
...
data_counts_VOP <- data_ordinary_tom2021_VOP %>%
                      #first make a variable that we will group results by:
                      mutate(Year_custom = case_when( Year == 2021 ~ "2021",
                                                      Year < 2021 ~ "T.o.m. 2020",
                                                      #Year == 2021 ~ "2021",
...
#changing the names to appear in table:
  ...
  popCharTab_ft <- norspis2::make_table_popchar(
                              RegData = data_ordinary_tom2021_only_start_VOP, 
...
# # #To print:
  flextable::save_as_image(popCharTab_ft, path=paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "sosiodemCharAlleAar2.png"))
  flextable::save_as_docx(
...
og med 2020. N angir antall gyldige observasjoner"= popCharTab_ft, 
                          path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "sosiodemCharAlleAar2.docx"))
...
# # #To print:
  ...
  flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "negativeEvents.docx"))
...
popCharTab_ft <- 
  norspis2::make_table_popchar(
    RegData = data_ordinary_tom2021_only_end_avbrudd_utred_VOP, 
    varsInTab = myvarString,
    varsNames = myvarNames,
...
#  print(ft, preview="docx")
# # #To print:
flextable::save_as_image(popCharTab_ft, path="~/.ssh/norspisdata_aarsrapp2021_VOP/sosiodemCharAlleAar.png")
flextable::save_as_docx("diagnoser" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "diagnoses.docx"))
...
# # #To print:
  ...
  flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "bmiStart.docx"))
...
popCharTab_ft <- 
  norspis2::make_table_popchar(
    RegData = data_ordinary_tom2021_only_end_ikkeavbrudd_VOP, 
    varsInTab = myvarString,
    varsNames = myvarNames,
    font_size_ft = 8,
    row_height_ft = 0.2,
...
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "bmiEnd.docx"))
...
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "psychofarmacaStart.docx"))
...
flextable::save_as_docx("sosiodemCharAlleAar" = popCharTab_ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "psychofarmacaEnd.docx"))
...
ft
 ...
 flextable::save_as_docx("variabelkompletthet2021" = ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "variabelkompletthet2021.docx"))
...
ft
 ...
 flextable::save_as_docx("variabelkompletthet_KI_2021" = ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "variabelkompletthet_KI_2021.docx"))
...
ft
 ...
 flextable::save_as_docx("variabelkompletthet_PasErf_og_PT_2021" = ft, path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "variabelkompletthet_PasErf_og_PT_2021.docx"))
...
<!-- kableExtra::save_kable(x = table_BU_spec_kable_html, file = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "table_BU_spec.jpeg")) -->

<!-- #preview -->
<!-- print(table_BU_spec, preview="docx") -->

<!-- flextable::save_as_docx("table_BU_spec" = table_BU_spec,  -->
<!--                         path = "~/.ssh/norspisdata_aarsrapp2021_VOP/table_BU_spec.docx" -->
<!--                         ) -->
...
<!-- #                           path = paste0("~/.ssh/norspisdata_aarsrapp2021_VOP/", "KI4_PROP_PO09Utbytte_time.docx")) -->
